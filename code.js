...
onEvent("Footer.Home", "click", function( ) {
	open("https://github.lemoncube.dev/");
});
...
onEvent("Active", "click", function( ) {
	playSound("assets/Active.mp3", true);
});
onEvent("Return", "click", function( ) {
	setScreen("HighRockSightseeing");
});
onEvent("Footer.Music", "click", function( ) {
	open("https://github.lemoncube.dev/");
});
